...
2. Add these variables:
   ...
   - **Key:** `DATABASE_URL` → **Value:** your Supabase/Neon Postgres connection string
...
| Database | Postgres | Supabase/Neon/Render Postgres | Required for persistent products |
...
4. Set `DATABASE_URL` to a Postgres database so products persist
